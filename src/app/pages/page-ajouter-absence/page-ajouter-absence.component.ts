...
@Component({
  selector: 'app-page-ajouter-absence',
  templateUrl: './page-ajouter-absence.component.html',
  styleUrls: ['./page-ajouter-absence.component.scss']
})

export class PageAjouterAbsenceComponent implements OnInit {
